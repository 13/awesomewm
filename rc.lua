...
mytextclock = wibox.widget.textclock(" %a %d.%m %H:%M ", 60)
...
globalkeys = gears.table.join(
   ...
   -- User programs custom
     ...
     awful.key({ modkey }, "d", function () awful.util.spawn(explorer) end),
     awful.key({ modkey }, "v", function () awful.util.spawn(vdr) end),
     awful.key({ modkey, "Shift" }, "a", function () awful.util.spawn("/home/ben/bin/lock.sh") end),
     awful.key({ modkey, "Shift" }, "s", function () awful.util.spawn("/home/ben/bin/panic.sh") end),
...
awful.rules.rules = {
    ...
    -- VDR
    --{ rule = { name = "Kodi", "VDR" },
      --properties = { screen = 1, tag = "4", fullscreen = true, ontop = true, switchtotag = true } },
    --  properties = { screen = 1, tag = "4" } },
    { rule = { class = "VDR" },
      --properties = { screen = 1, tag = "4", fullscreen = true, ontop = true, switchtotag = true } },
      properties = { screen = screen.count(), tag = "4", switchtotag = true } },
    { rule = { class = "Kodi" },
      --properties = { screen = 1, tag = "4", fullscreen = true, ontop = true, switchtotag = true } },
      properties = { screen = screen.count(), tag = "4", switchtotag = true } },
